        ...
        <div class="d-flex flex-column justify-content-center align-items-center mt-4">
            ...
            <form method="POST" action="">
                <div>
                    ...
                    <input type="submit" value="Submit" class="btn btn-secondary mt-4" disabled id="buttonDisable" name = "enterData">
            ...
            <cfif structKeyExists(form, "enterData")> 
                ...
                <cfset local.result = local.value.checkData(form.firstName, form.mailId)>
            </cfif>
        </div>
    </cfoutput>

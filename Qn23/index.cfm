...
<body>
    <div class = "d-flex justify-content-center">
        ...
        <cfif structKeyExists(form, "submit")>
            ...
            <cfset local.result = local.value.insertDetails(form.position,form.relocate,local.start,
                                    form.emailInput,local.phone,form.nameInputFirst,form.nameInputLast)>
        </cfif>   
    </div>
